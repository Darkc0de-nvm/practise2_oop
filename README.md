...
> **Примітка щодо `using`:** У проєктах використовується механізм **Implicit Usings**. Основні простори імен (як-от `System` та `System.Collections.Generic`) підключаються автоматично на рівні конфігурації проєкту, тому врахуйте це при запуску :)
